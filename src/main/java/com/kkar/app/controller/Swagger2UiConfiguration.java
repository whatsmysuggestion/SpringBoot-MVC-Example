/*
 * package com.kkar.app.controller;
 * 
 ...
 * regex("/next.*")); }
 * 
 * private ApiInfo apiInfo() { return new ApiInfoBuilder().title("KKAR API")
 * .description("KKAR API reference for developers")
 * .termsOfServiceUrl("http://kkar.in")
 * .contact("kkar@gmail.com").license("kkar License")
 * .licenseUrl("kkar@gmail.com").version("1.0").build(); } }
 * 
 */